from data_collector.carla import sensor
from data_collector.carla.settings import CarlaSettings
"""
...
def make_carla_settings():
    ...
    camera0.set(FOV=FOV)
    camera0.set_position(2.0, 0.0, 1.8) # x,y,z
