...
from lanenet_lane_detection.config import global_config
...
class LaneNetPostProcessor(object):
    ...
    """
    def __init__(self, ipm_remap_file_path='lanenet_lane_detection/data/tusimple_ipm_remap.yml'):
        """
    ...
    def postprocess(self, binary_seg_result, instance_seg_result=None,
        ...
        print('SHAPE YOOO: ', morphological_ret.shape, instance_seg_result.shape)
        ...
        source_image = cv2.resize(source_image, (1280, 720), interpolation=cv2.INTER_LINEAR)
